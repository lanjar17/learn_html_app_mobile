...
import 'package:learnhtml/main_pages/project/model/project_page_data.dart';
import 'provider/page_view_provider.dart';

class Project1Page extends ConsumerWidget {
  const Project1Page({Key? key});
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                _showAnswers(context, 'assets/images/project1.png');
              },
              style: ElevatedButton.styleFrom(
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(18.0),
