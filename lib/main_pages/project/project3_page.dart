...
import 'package:learnhtml/main_pages/project/model/project_page3_data.dart';
import 'provider/page3_view_provider.dart';

class Project3Page extends ConsumerWidget {
  const Project3Page({Key? key});
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          Padding(
            ...
            child: InkWell(
              onTap: () {
                Navigator.pushReplacementNamed(context, "/Project2Page");
              },
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                ...
                _showAnswers(context, 'assets/images/project3.png');
              },
              style: ElevatedButton.styleFrom(
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(18.0),
